...
@interface AbstractLoadingCV() <NSTextFieldDelegate>
{
...
@implementation AbstractLoadingCV
{
    struct {
...
- (id)initWithWindowNibName:(NSString *)nibName delegate:(id <LoadingVCDelegate>) del actionCode:(NSInteger) code
{
...
- (id)initWithDelegate:(id <LoadingVCDelegate>) del actionCode:(NSInteger) code
{
