...
//    }
    ...
    QByteArray ba = QByteArray::fromStdString(model_->owner.contactModel->getContact(conversation.participants[0]).profileInfo.avatar);
...
// TODO : Find the purpose of the following method & reimplement if needed
