...
- (NSView *)outlineView:(NSOutlineView *)outlineView viewForTableColumn:(NSTableColumn *)tableColumn item:(id)item
{
    ...
    if ([outlineView.identifier isEqualToString:ID_AUDIO]) {
        ...
        [details setStringValue:[NSString stringWithFormat:@"%@", AccountModel::instance().selectedAccount()->codecModel()->videoCodecs()->data(qIdx, CodecModel::Role::BITRATE).toString().toNSString()]];
