...
@interface AbstractLoadingCV :  NSWindowController <LoadingVCProtocol>
{
@protected
 ...
 */
@property (retain, nonatomic) id <LoadingVCDelegate> delegate;
...
- (id)initWithWindowNibName:(NSString *)nibName
                   delegate:(id <LoadingVCDelegate>) del
