...
{
    [super loadView];
    RecentModel::instance().peopleProxy()->setFilterRole(Qt::DisplayRole);
    _treeController = [[QNSTreeController alloc] initWithQModel:RecentModel::instance().peopleProxy()];
...
- (NSView *)outlineView:(NSOutlineView *)outlineView viewForTableColumn:(NSTableColumn *)tableColumn item:(id)item
{
    ...
    auto finalIdx = RecentModel::instance().peopleProxy()->mapToSource(qIdx);
...
- (void)controlTextDidChange:(NSNotification *) notification
{
    ...
    RecentModel::instance().peopleProxy()->setFilterRegExp(QRegExp(QString::fromNSString(textView.textStorage.string),
                                                                   Qt::CaseInsensitive,
                                                                   QRegExp::FixedString));
