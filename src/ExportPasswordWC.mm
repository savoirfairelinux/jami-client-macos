...
{
    NSMutableAttributedString* hereAreThePin = [[NSMutableAttributedString alloc] initWithString:NSLocalizedString(@"Your generated pin:","Title shown to user to concat with Pin")];
    ...
    [hereAreThePin appendAttributedString:thePin];
    ...
    [hereAreThePin appendAttributedString:infos];

    return hereAreThePin;
}
