...
{
    NSMutableAttributedString* hereAreThePin = [[NSMutableAttributedString alloc] initWithString:NSLocalizedString(@"Heare are your Pin code generated:","Title shown to user to concat with Pin")];
