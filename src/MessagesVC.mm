...
- (void)imagePreview:(id)sender {
    ...
    [containerView addSubview:imageView positioned:NSWindowAbove relativeTo:nil];
    ...
    NSString* formatHeight = [NSString stringWithFormat:@"V:|-[imageView]-|"];
    NSString* formatWidth = [NSString stringWithFormat:@"H:|-[imageView]-|"];
...
- (void)closePreview:(id)sender {
    NSView* imageView = [sender superview];
    [imageView removeFromSuperview];
}
