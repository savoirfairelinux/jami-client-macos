...
-(bool) sequenceAuthorChangedFrom:(lrc::api::interaction::Info) firstInteraction to:(lrc::api::interaction::Info) secondInteraction {
    ...
    if ((secondInteraction.type == lrc::api::interaction::Type::TEXT
         || secondInteraction.type == lrc::api::interaction::Type::INCOMING_DATA_TRANSFER
         || secondInteraction.type == lrc::api::interaction::Type::OUTGOING_DATA_TRANSFER) && (isOutgoing == lrc::api::interaction::isOutgoing(secondInteraction))) {
        authorChanged = NO;
    }
