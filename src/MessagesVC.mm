...
// views size
CGFloat   const GENERIC_CELL_HEIGHT       = 34;
...
-(NSTableCellView*) makeGenericInteractionViewForTableView:(NSTableView*)tableView withText:(NSString*)text andTime:(NSString*) time
{
    ...
    [timeField setWantsLayer:YES];
    timeField.layerContentsRedrawPolicy = NSViewLayerContentsRedrawOnSetNeedsDisplay;
