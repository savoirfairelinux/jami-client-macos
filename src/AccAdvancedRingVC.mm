...
- (IBAction)selectContact:(id)sender
{
    if (contactPickerPopoverVC != nullptr) {
        ...
        [contactSelectorVC setContactModel:contModel andAccountId:self.selectedAccountID andAccountModel:self.accountModel];
...
-(void)chosenContact:(const QString&)contactUri {
