...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    if (self.pointerDirection == LEFT)
    {
        ...
        if(self.needPointer) {
            ...
            CGPathAddLineToPoint(outlinePath, nil, minx, maxy - 8);
            CGPathAddLineToPoint(outlinePath, nil, minx - 5, maxy - 0);
    ...
    else
    {
        ...
        if(self.needPointer) {
            CGPathAddArcToPoint(outlinePath, nil, maxx, maxy, maxx, midy, 0);
            CGPathAddLineToPoint(outlinePath, nil, maxx, maxy - 8);
            CGPathAddLineToPoint(outlinePath, nil, maxx + 5, maxy - 0);
