...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    if (self.pointerDirection == LEFT)
    {
        ...
        if(self.needPointer) {
            ...
            CGPathAddLineToPoint(outlinePath, nil, minx - 5, maxy - 15);
        ...
        CGContextSetShadowWithColor(context, CGSizeMake(0,1), 1, [NSColor controlHighlightColor].CGColor);
    ...
    else
    {
        ...
        if(self.needPointer) {
            ...
            CGPathAddLineToPoint(outlinePath, nil, maxx + 5, maxy - 15);
