...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    if (self.mouseDown || self.state == NSOnState) {
        backgroundColor6 = [[NSColor ringBlue] darkenColorByValue:0.3];
        backgroundStrokeColor5 = [[NSColor ringBlue] darkenColorByValue:0.4];
    } else {
        backgroundColor6 = [NSColor ringBlue];
        backgroundStrokeColor5 = [[NSColor ringBlue] darkenColorByValue:0.1];
    }
