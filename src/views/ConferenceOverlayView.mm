...
- (void)configureView {
    ...
    if ([self.delegate isMasterCall]) {
        ...
        self.settingsButton.highlightColor = [NSColor lightGrayColor];
        ...
        [self.settingsButton.trailingAnchor constraintEqualToAnchor: self.gradientView.trailingAnchor constant: -5].active = true;
    ...
    self.usernameLabel.font = [NSFont userFontOfSize: 16.0];
    self.usernameLabel.translatesAutoresizingMaskIntoConstraints = false;
    [self.gradientView addSubview:self.usernameLabel];

    [self.usernameLabel.heightAnchor constraintEqualToConstant:25].active = true;
    [self.usernameLabel.leadingAnchor constraintEqualToAnchor: self.gradientView.leadingAnchor constant: 10].active = true;
    [self.usernameLabel.trailingAnchor constraintEqualToAnchor: self.gradientView.trailingAnchor constant: -55].active = true;
    [self.usernameLabel.bottomAnchor constraintEqualToAnchor:self.gradientView.bottomAnchor constant: -5].active = true;
}
