...
- (IBAction)muteAudio:(id)sender {
    ...
    auto* callModel = accountInfo_->callModel.get();
    auto& currentCall = callModel->getCall([self getcallID]);
    callModel->requestMediaChange([self getcallID], "audio_0", "", 2, !currentCall.audioMuted);
...
- (IBAction)muteVideo:(id)sender
{
    ...
    auto* callModel = accountInfo_->callModel.get();
    auto& currentCall = callModel->getCall([self getcallID]);
    callModel->requestMediaChange([self getcallID], "video_0", "", 2, !currentCall.videoMuted);
