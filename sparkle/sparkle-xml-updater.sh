...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle" xmlns:dc="http://purl.org/dc/elements/1.1/">
    <channel>
        ...
        <item>
            ...
            <enclosure url="${REPO_URL}/$(basename ${PACKAGE})" sparkle:version="$VERSION_NUMBER" sparkle:shortVersionString="${VERSION_NAME}" length="$PACKAGE_SIZE" type="application/octet-stream" sparkle:dsaSignature="$(./sign_update.sh ${PACKAGE} ${DSA_KEY})" />
