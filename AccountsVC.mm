...
- (IBAction)addAccount:(id)sender {
    ...
    Account* newAcc =AccountModel::instance()->add("New Account", qIdx);
}

- (IBAction)protocolSelectedChanged:(id)sender {

    int index = [sender indexOfSelectedItem];
    AccountModel::instance()->protocolModel()->selectionModel()->setCurrentIndex(AccountModel::instance()->protocolModel()->index(index), QItemSelectionModel::ClearAndSelect);
...
//    if([configPanels tabViewItemAtIndex:0]==ringTabItem)
//    {
//        [configPanels removeTabViewItem:ringTabItem];
//        [configPanels insertTabViewItem:generalTabItem atIndex:0];
//        if(selected == ringTabItem)
//            [configPanels selectFirstTabViewItem:nil];
//    }
...
- (void) setupRINGPanelsForAccount:(Account*) acc
{
    ...
    [configPanels insertTabViewItem:advancedTabItem atIndex:3];
    [configPanels insertTabViewItem:securityTabItem atIndex:4];
//    if([configPanels tabViewItemAtIndex:0]==generalTabItem)
//    {
//        [configPanels removeTabViewItem:generalTabItem];
//        [configPanels insertTabViewItem:ringTabItem atIndex:0];
//        if(selected == generalTabItem)
//            [configPanels selectFirstTabViewItem:nil];
//    }
