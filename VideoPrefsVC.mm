...
- (void)loadView
{
    ...
    QModelIndex qOutputIdx = Video::SourcesModel::instance()->index(Video::SourcesModel::instance()->activeIndex());
    [self.videoDevicesList addItemWithTitle:Video::SourcesModel::instance()->data(qOutputIdx, Qt::DisplayRole).toString().toNSString()];


    //Video::DeviceModel::instance()-
  //  Video::Device* device = Video::SourcesModel::instance()->deviceAt(qOutputIdx);
//    device->
    [self.videoDevicesList addItemWithTitle:Video::SourcesModel::instance()->data(qOutputIdx, Qt::DisplayRole).toString().toNSString()];
