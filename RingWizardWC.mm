...
@synthesize emailSharingService;
...
- (void)windowDidLoad {
    ...
    emailSharingService = [NSSharingService sharingServiceNamed:NSSharingServiceNameComposeEmail];
...
- (void) displayHash:(NSString* ) hash
{
    ...
    [createButton setTitle:emailSharingService.title];
